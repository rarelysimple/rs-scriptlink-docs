...
* [RarelySimple.AvatarScriptLink.Services](https://www.nuget.org/packages/RarelySimple.AvatarScriptLink.Services)
...
<Tabs groupId="ide" queryString="ide">
    <TabItem value="vs" label="Visual Studio" default>
        ...
        2. Select Browse and search for *AvatarScriptLink*.
        3. Select `RarelySimple.AvatarScriptLink.Net` by Scott Olson Jr and install this in your project.
        4. Select `RarelySimple.AvatarScriptLink.Services` by Scott Olson Jr and install this in your project.
        5. Select Browse and search for *SoapCore*. Select `SoapCore` by Digital Design and install this in your project.
        6. Select the Install tab, clear the search text and confirm you now have two packages installed in your project.
    </TabItem>
    <TabItem value="code" label="Visual Studio Code">
        1. Change to the project directory.
        2. Select View > Terminal (Ctrl + `) to show the Terminal.
        2. Install RarelySimple.AvatarScriptLink.Net with `dotnet add package RarelySimple.AvatarScriptLink.Net`.
        2. Install RarelySimple.AvatarScriptLink.Services with `dotnet add package RarelySimple.AvatarScriptLink.Services`.
